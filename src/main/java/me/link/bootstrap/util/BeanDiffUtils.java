...
import me.link.bootstrap.core.domain.FieldChangeDO;
...
public final class BeanDiffUtils {
     ...
     */
    public static List<FieldChangeDO> diff(Object oldObj, Object newObj) {
        ...
        List<FieldChangeDO> details = new ArrayList<>(annotatedFields.size());
